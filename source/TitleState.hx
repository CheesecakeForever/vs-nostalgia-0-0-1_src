...
class TitleState extends MusicBeatState
{
	...
	var easterEggKeys:Array<String> = [
		'SHADOW', 'RIVER', 'SHUBS', 'BBPANZU', 'CHEESE'
	];
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			case 'CHEESE':
				gfDance.frames = Paths.getSparrowAtlas('CheeseBump');
				gfDance.animation.addByPrefix('danceLeft', 'Beat', 24, false);
				gfDance.animation.addByPrefix('danceRight', 'Beat', 24, false);
			#end
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.visible = true;
				case 14:
					addMoreText('Vs Nostalgia');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('By Cheesecake'); // credTextShit.text += '\nFunkin';
		...
		if (!skippedIntro)
		{
			if (playJingle) //Ignore deez
			{
				...
				switch(easteregg)
				{
					...
					case 'CHEESE':
						sound = FlxG.sound.play(Paths.sound('JingleCheese'));
