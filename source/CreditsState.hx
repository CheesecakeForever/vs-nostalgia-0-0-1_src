...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('BG/desat'));
		add(bg);
		bg.screenCenter();
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs Nostalgia'],
			['Cheesecake',			'cheese',			'"I HAVE TO DO EVERYTHING MYSELF :skull:"  - Cheesecake',	'https://twitter.com/Shadow_Mario_',	'EF9D56'],
			[''],
			['Psych Engine Team'],
